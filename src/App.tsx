...
export default function AssemProjectsDashboard() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800">
      ...
      {/* Layout */}
      <div className="mx-auto grid max-w-screen-2xl grid-cols-12 gap-6 px-4 py-6">
        {/* Sidebar */}
                ...
                <Table>
                  <TableHeader className="bg-slate-50">
                    <TableRow>
                      ...
                      <TableHead className="hidden lg:table-cell w-[220px]">CLIENTES</TableHead>
                      <TableHead className="hidden md:table-cell w-[120px]">ACCIONES</TableHead>
